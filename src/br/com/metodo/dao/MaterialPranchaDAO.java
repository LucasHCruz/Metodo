...
public class MaterialPranchaDAO implements DAO<MaterialPrancha>
{
	...
	{
		String sql = "INSERT INTO material_prancha (codigo, nome) VALUES (SEQ_MPRANCHA.nextval,?)";
		try
		{
			PreparedStatement ps = conn.prepareStatement(sql);

			ps.setString(1, materialPrancha.getNome());
	...
	@Override
	public MaterialPrancha read(String codigo)
	{
		String sql = "SELECT codigo,nome FROM material_prancha";
